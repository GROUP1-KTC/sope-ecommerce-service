...
// public void run() {
// // ===== Cấp 1 =====
// Category menFashion = createCategory("Thời trang nam", null, 1, new
// BigDecimal("5.5"));
// Category womenFashion = createCategory("Thời trang nữ", null, 1, new
// BigDecimal("5.5"));
// Category phoneAccessory = createCategory("Điện thoại & Phụ kiện", null, 1,
// new BigDecimal("8.5"));
// Category kidFashion = createCategory("Thời trang trẻ em", null, 1, new
// BigDecimal("5.5"));
// Category homeAppliance = createCategory("Thiết bị gia dụng", null, 1, new
// BigDecimal("10.0"));
// Category computerLaptop = createCategory("Computer & Laptop", null, 1, new
// BigDecimal("8.5"));

// // ===== Cấp 2 =====
// Category jacket = createCategory("Áo khoác", menFashion, 2, new
// BigDecimal("5.5"));
// Category aoThun = createCategory("Áo thun", menFashion, 2, new
// BigDecimal("5.5"));
// Category quanNu = createCategory("Quần", womenFashion, 2, new
// BigDecimal("5.5"));
// Category aoVest = createCategory("Áo Vest", womenFashion, 2, new
// BigDecimal("5.5"));
// Category vayCuoi = createCategory("Váy cưới", womenFashion, 2, new
// BigDecimal("8.5"));
...
// private Category createCategory(String name, Category parent, int level,
