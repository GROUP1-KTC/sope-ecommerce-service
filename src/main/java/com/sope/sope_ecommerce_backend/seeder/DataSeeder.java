...
// 2. Users
        ...
        Product prod1 = Product.builder()
                ...
                .category(cat1)
                .defaultImage("https://product.hstatic.net/200000588671/product/ao-so-mi-n…bycotton-trang-art-nhan_8ec622a241ea4deb93a02bdbdcb87954.jpg")
        ...
        Product prod8 = Product.builder()
                ...
                .status(StatusProduct.APPROVED)
                .category(cat5)
                .defaultImage("https://img.mwc.com.vn/giay-thoi-trang?w=480&h=510&FileInpu…24/07/22/z5657421577987_9a0ce55fc8fb9f44faf88aa40d94736c.jpg")
                .shop(shop1)
                .build();
        ...
        Product prod10 = Product.builder()
                ...
                .category(cat5)
                .shop(shop1)
                .defaultImage("https://cdn2.cellphones.com.vn/insecure/rs:fill:0:358/q:90/…ia/catalog/product/d/i/dien-thoai-samsung-galaxy-s25_13_.png")
                .build();
        ...
        Product prod12 = Product.builder()
                ...
                .category(cat2)
                .shop(shop3)
                .defaultImage("https://product.hstatic.net/200000722513/product/logitech-g…29c4a0f81b8e8a2feebe4d8_aeb4ae49ee844c3e9d315883d4e482d4.jpg")
                .build();
