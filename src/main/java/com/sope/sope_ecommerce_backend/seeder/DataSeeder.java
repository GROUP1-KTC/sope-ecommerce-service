...
//        List.of("USER"), "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1756889312/cylfn98scm57at8njpfp.jpg");
//
...
//        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757908319/jhd1srfhohzrzudc7vnc.gif", false);
//
...
//        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757907798/dzg1fg4eaayh0p8hosq3.jpg", false);
//
...
//                "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757907798/dzg1fg4eaayh0p8hosq3.jpg", false);
//
//        // 4. Categories - chuẩn từ CategorySeeder
...
//                .description("Áo sơ mi nam chất liệu cotton mềm mại, kiểu dáng trẻ trung")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757906811/ezkafi83wakk1cxwc3fi.webp")
//                .status(StatusProduct.APPROVED)
//                .category(aoThun) // gắn vào category Áo thun (level 2)
//                .shop(shop1)
//                .build();
//
//        Product prod2 = Product.builder()
...
//                .description("Váy nữ dịu dàng, phù hợp mọi dịp")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757898729/x4o516yrk7uqvbnickty.jpg")
//                .status(StatusProduct.APPROVED)
//                .category(vayCuoi) // gắn vào category Váy cưới (level 2)
//                .shop(shop1)
//                .build();
//
//        Product prod3 = Product.builder()
...
//                .description("Quần jeans nam bền bỉ, form slim fit")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757832968/zmpruokxtsnl6jdjicdk.jpg")
//                .status(StatusProduct.APPROVED)
//                .category(menFashion) // gắn trực tiếp category Thời trang nam (level 1)
//                .shop(shop1)
//                .build();
//
//        Product prod4 = Product.builder()
...
//                .description("Áo khoác nữ ấm áp cho mùa đông")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757832931/kpfs0raizp2wtawb6xwn.jpg")
//                .status(StatusProduct.APPROVED)
//                .category(aoVest) // gắn vào category Áo Vest (level 2)
//                .shop(shop3)
//                .build();
//
//        Product prod5 = Product.builder()
...
//                .brand("Dell")
//                .description("Laptop Dell hiệu năng ổn định cho văn phòng")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757832757/nvdlwvwgarrlrtyfkaok.jpg")
//                .status(StatusProduct.APPROVED)
//                .category(computerLaptop) // gắn Computer & Laptop (level 1)
//                .shop(shop3)
//                .build();
//
//        Product prod6 = Product.builder()
//                .name("Áo Khoác Mùa Đông Nam")
//                .slug("ao-khoac-mua-dong-nam")
//                .brand("WinterPro")
//                .description("Áo khoác mùa đông cho nam, giữ ấm cực tốt")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757788925/ipdgm8pjy0zlxgsg4i6z.jpg")
//                .status(StatusProduct.APPROVED)
//                .category(winterJacket) // gắn category Áo khoác mùa đông (level 3)
//                .shop(shop3)
//                .build();
//
//        Product prod7 = Product.builder()
...
//                .brand("Samsung")
//                .description("Điện thoại thông minh Android cấu hình cao")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757576070/e7jswpuu8qqhelgesvoc.png")
//                .status(StatusProduct.APPROVED)
//                .category(phoneAccessory) // gắn vào Điện thoại & Phụ kiện
//                .shop(shop3)
//                .build();
//
//        Product prod8 = Product.builder()
...
//                .slug("may-hut-bui")
//                .brand("Panasonic")
//                .description("Máy hút bụi công suất mạnh, tiết kiệm điện")
//                .defaultImage(
//                        "https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757526063/v1gepqksfjyfstf2svql.webp")
//                .status(StatusProduct.APPROVED)
//                .category(homeLiving) // gắn vào Thiết bị gia dụng
//                .shop(shop1)
//                .build();
//
...
//        orderRepository.saveAll(Arrays.asList(order1, order2, order3, order4, order6));
//
//        // 9. Reviews - chỉ tạo review cho user đã mua hàng (order DELIVERED/COMPLETED)
//        ReviewEntity review1 = ReviewEntity.builder()
//                .appUser(appUser2) // order3 của appUser2
//                .productVariant(variant3) // đã mua trong order3
//                .rating(5)
//                .content("Quần jeans rất đẹp, chất vải dày dặn, form vừa vặn.")
//                .createdAt(LocalDateTime.now().minusDays(5))
//                .updatedAt(LocalDateTime.now().minusDays(5))
//                .build();
//
//        ReviewMediaEntity review1_img1 = ReviewMediaEntity.builder()
//                .priority(1)
//                .url("https://res.cloudinary.com/dybo8zd4y123/image/upload/v1757918818/v2zlt8mdbjvsnalfup4j.jpg")
//                .review(review1)
//                .build();
//
//        review1.getMediaList().add(review1_img1);
//
//        ReviewEntity review2 = ReviewEntity.builder()
//                .appUser(appUser5) // order4 của appUser5
//                .productVariant(variant5) // đã mua laptop
//                .rating(4)
//                .content("Laptop chạy ổn, pin tạm được, giao hàng nhanh.")
//                .createdAt(LocalDateTime.now().minusDays(3))
//                .updatedAt(LocalDateTime.now().minusDays(3))
//                .videoReviewUrl(
//                        "https://res.cloudinary.com/dybo8zd4y123/video/upload/v1757555116/spcqyivzw0ebu1lulct8.mp4")
//                .build();
//
//        ReviewEntity review3 = ReviewEntity.builder()
//                .appUser(appUser5) // cùng order4
//                .productVariant(variant7) // đã mua điện thoại
//                .rating(5)
//                .content("Điện thoại Samsung mượt, camera chụp đẹp.")
//                .createdAt(LocalDateTime.now().minusDays(2))
//                .updatedAt(LocalDateTime.now().minusDays(2))
//                .build();
//
//        ReviewMediaEntity review3_img1 = ReviewMediaEntity.builder()
//                .priority(1)
//                .url("https://res.cloudinary.com/dybo8zd4y123/image/upload/v1758014112/mz8mdjsqkivkomf3yirw.jpg")
//                .review(review3)
//                .build();
//
//        ReviewEntity review4 = ReviewEntity.builder()
//                .appUser(appUser5) // cùng order4
//                .productVariant(variant1_extra) // đã mua áo sơ mi variant extra
//                .rating(3)
//                .content("Áo sơ mi đẹp nhưng hơi rộng hơn so với size đặt.")
//                .createdAt(LocalDateTime.now().minusDays(1))
//                .updatedAt(LocalDateTime.now().minusDays(1))
//                .build();
//
//        review3.getMediaList().add(review3_img1);
//
//        reviewRepository.saveAll(Arrays.asList(review1, review2, review3, review4));
//
//        System.out.println("✅ Review data seeded thành công!");
//
//        System.out.println("✅ Seeder data created successfully with expanded data for algorithms!");
//>>>>>>> 5024efa1a2d7c0def1e0ad0b5ee107e1753e5474
//    }
//
//    private AppUser createUserIfNotExists(String username, String name, String email, String rawPassword,
//            List<String> roleNames, String avatarUrl) {
...
//
//            System.out.println(
//                    "✅ Đã tạo cửa hàng: " + name + " cho username: " + username + " với user_id: " + user.getId());
